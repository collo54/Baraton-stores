...
class AllProductsLayout extends StatefulWidget {
  const AllProductsLayout({Key? key, this.checkoutItem}) : super(key: key);
  ...
  @override
  State<AllProductsLayout> createState() => _AllProductsLayoutState();
}
      ...
      children: [
        ...
        Padding(
          ...
          child: StreamBuilder<List<ProductItem>>(
            stream: firestoreservice.productItemStreamAll(),

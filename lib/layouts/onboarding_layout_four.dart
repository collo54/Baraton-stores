...
import 'package:baraton_stores/pages/onboarding_page_five_a.dart';
...
class OnboardingLayoutFour extends StatelessWidget {
  const OnboardingLayoutFour({Key? key}) : super(key: key);
  ...
  _gotoAutheticationpage(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const OnboardingPageFiveA()),
    );
  }

...
class OnboardingLayoutFiveB extends StatefulWidget {
  const OnboardingLayoutFiveB({Key? key}) : super(key: key);

  @override
  State<OnboardingLayoutFiveB> createState() => _OnboardingLayoutFiveBState();
}

class _OnboardingLayoutFiveBState extends State<OnboardingLayoutFiveB> {
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const OnboardingPageFour()),
              );
            },
            child: Text(

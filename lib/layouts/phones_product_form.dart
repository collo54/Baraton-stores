...
class PhonesProductForm extends StatefulWidget {
  const PhonesProductForm({Key? key, this.product}) : super(key: key);
  final ProductItem? product;

  @override
  State<PhonesProductForm> createState() => _PhonesProductFormState();
}

class _PhonesProductFormState extends State<PhonesProductForm> {
  ...
  Future<void> _submit() async {
    if (_validateAndSaveForm()) {
      ...
      await firestoreservice.setProduct2(item);
